...
this.route('quickVote',{
    path: '/quickVote',
    waitOn: function() { return [Meteor.subscribe("users")
    ,Meteor.subscribe("userinfo"),Meteor.subscribe('quickvote'),Meteor.subscribe('quickvoter')]; 
    }
})
...
this.route('nationalVote',{
    path: '/nationalVote',
    waitOn: function() { return [Meteor.subscribe("users")
    ,Meteor.subscribe("userinfo"),Meteor.subscribe('nationalvote'),Meteor.subscribe('nationalvoter')]; 
    }
...
this.route('quickstats',{
    path:'/quickstats',
    waitOn: function() { return [Meteor.subscribe('quickvote')]; 
    }
